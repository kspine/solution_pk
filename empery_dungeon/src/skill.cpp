...
namespace {
	...
	void get_cleave_skill_effect_range(std::vector<Coord> &ret, Coord origin,Skill::Skill_Direct direct){
		...
		LOG_EMPERY_DUNGEON_FATAL("get_cleave_skill_effect_range,origin coord = ", origin, " direct = ", direct);
...
void  SkillCleave::do_effects(){
	...
	LOG_EMPERY_DUNGEON_ERROR("get_cleave_skill_effect_range coords.size = ",coords.size());
