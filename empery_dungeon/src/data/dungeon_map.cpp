...
namespace {
	...
	const auto MAX_DUNGE_MAP_COUNT = 12;
	const std::string  DUNGEON_MAP_FILES[MAX_DUNGE_MAP_COUNT] = {"dungeon_map_1_1","dungeon_map_1_2","dungeon_map_1_3","dungeon_map_1_4","dungeon_map_1_5","dungeon_map_1_6",
