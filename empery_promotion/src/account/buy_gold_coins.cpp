...
ACCOUNT_SERVLET("buyGoldCoins", session, params){
	...
	transaction.emplace_back(info.account_id, ItemTransactionElement::OP_REMOVE, ItemIds::ID_GOLD_COINS, amount,
		Events::ItemChanged::R_BUY_GOLD_COINS, amount, 0, 0, serial);
