#ifndef EMPERY_CENTER_EVENTS_AUCTION_HPP_
#define EMPERY_CENTER_EVENTS_AUCTION_HPP_
...
namespace Events {
	struct AuctionItemChanged : public Poseidon::EventBase<340401> {
		...
		AuctionItemChanged(AccountUuid account_uuid_,
