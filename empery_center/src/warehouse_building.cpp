...
namespace {
	boost::shared_ptr<MySql::Center_WarehouseBuilding> create_default_defense_obj(MapObjectUuid map_object_uuid){
		PROFILE_ME;

		auto obj = boost::make_shared<MySql::Center_WarehouseBuilding>(map_object_uuid.get(),
			0, WarehouseBuilding::MIS_NONE, 0, 0, 0, Poseidon::Uuid(), 0);
