#ifndef EMPERY_CENTER_CONTROLLER_CLIENT_HPP_
#define EMPERY_CENTER_CONTROLLER_CLIENT_HPP_
...
class ControllerClient : public Poseidon::Cbpp::Client {
public:
	using Result = std::pair<Poseidon::Cbpp::StatusCode, std::string>;

	using ServletCallback = boost::function<
		Result (const boost::shared_ptr<ControllerClient> &, Poseidon::StreamBuffer)>;
...
public:
	...
	static boost::shared_ptr<ControllerClient> get();
	static boost::shared_ptr<ControllerClient> require();
