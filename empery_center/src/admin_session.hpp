#ifndef EMPERY_CENTER_ADMIN_HTTP_SESSION_HPP_
#define EMPERY_CENTER_ADMIN_HTTP_SESSION_HPP_
...
public:
	using ServletCallback = boost::function<
		 std::pair<long, std::string> (Poseidon::JsonObject &, const boost::shared_ptr<AdminHttpSession> &, Poseidon::OptionalMap)>;
