#ifndef EMPERY_CENTER_ACCOUNT_SESSION_HPP_
#define EMPERY_CENTER_ACCOUNT_SESSION_HPP_
...
class AccountSession : public Poseidon::Http::Session {
public:
	using ServletCallback = boost::function<
		 std::pair<long, std::string> (Poseidon::JsonObject &, const boost::shared_ptr<AccountSession> &, Poseidon::OptionalMap)>;
...
public:
	AccountSession(Poseidon::UniqueFile socket,
