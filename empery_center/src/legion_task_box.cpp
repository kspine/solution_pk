...
namespace EmperyCenter {
	namespace {
		...
		using TaskObjectPair = std::pair<boost::shared_ptr<MySql::Center_LegionTask>, std::pair<boost::shared_ptr<LegionTaskBox::Progress>,boost::shared_ptr<LegionTaskBox::Progress>>>;
