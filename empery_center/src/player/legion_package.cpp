...
namespace EmperyCenter
{
    ...
    PLAYER_SERVLET(Msg::CS_ReceiveTaskRewardReqMessage, account, session, req)
    {
		...
		//领取信息存储
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============分享者领取礼包流程{记录军团礼包领取记录:开始} ");
		...
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============分享者领取礼包流程{记录军团礼包领取记录:结束} ");
		...
		//分享信息存储
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============分享者分享礼包流程{记录军团礼包分享记录:开始} ");
		...
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============分享者分享礼包流程{记录军团礼包分享记录:结束} ");


		//客户端分享同步消息
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============客户端分享同步消息:开始 ");
		...
		LOG_EMPERY_CENTER_DEBUG("CS_ReceiveTaskRewardReqMessage =============客户端分享同步消息:结束 ");
