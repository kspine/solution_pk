...
namespace EmperyCenter
{
	namespace Data
	{
		...
		{
		  public:
				static boost::shared_ptr<const NoviceGuideSetup> get(NoviceGuideStepId step_id);
				static boost::shared_ptr<const NoviceGuideSetup> require(NoviceGuideStepId step_id);
