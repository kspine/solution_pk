...
namespace Data {
	...
	public:
		...
		static void get_by_overlay_group(std::vector<boost::shared_ptr<const MapCellBasic>> &ret, OverlayGroupName overlay_group_name);

	public:
		std::pair<unsigned, unsigned> map_coord;
		TerrainId terrain_id;
		OverlayId overlay_id;
		OverlayGroupName overlay_group_name;
	};
