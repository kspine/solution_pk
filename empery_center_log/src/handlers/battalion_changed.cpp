...
MODULE_RAII_PRIORITY(handles, 5000){
	auto listener = Poseidon::EventDispatcher::register_listener<Events::BattalionChanged>(
		[](const boost::shared_ptr<Events::BattalionChanged> &event){
	...
	LOG_EMPERY_CENTER_LOG_DEBUG("Created BattalionChanged listener");
