#ifndef EMPERY_CENTER_LOG_MYSQL_BATTALION_CHANGED_HPP_
#define EMPERY_CENTER_LOG_MYSQL_BATTALION_CHANGED_HPP_
...
#define MYSQL_OBJECT_NAME   CenterLog_BattalionChanged
