...
*/
#define PLAYER_HTTP_SERVLET(uri_, sessionArg_, paramsArg_)	\
	namespace {	\
		namespace Impl_ {	\
	...
	MODULE_RAII(handles_){	\
		handles_.push(PlayerSession::createHttpServlet(uri_, & Impl_:: TOKEN_CAT3(PlayerHttpServlet, __LINE__, Entry_)));	\
	}	\
